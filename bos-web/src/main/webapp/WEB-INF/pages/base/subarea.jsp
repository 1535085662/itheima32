...
<script type="text/javascript">
	...
	function doHighchars() {
		$('#showHighcharsWindow').window("open");
		//发送ajax请求，获取区域分布数据
	...
	$(function() {
		...
		//定义一个方法，将form表单所有的输入项转化为json数据{key:value,key:value}
...
<body class="easyui-layout" style="visibility: hidden;">
	...
	<!-- 显示分区图 -->
	<div class="easyui-window" title="分区添加修改" id="showHighcharsWindow"
		collapsible="false" minimizable="false" maximizable="false"
		style="top: 20px; left: 200px">
		<div id="test" split="false" border="false"></div>
	</div>
	<!-- 查询分区 -->
